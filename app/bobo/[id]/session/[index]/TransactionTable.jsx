                    ...
                    <tbody className="divide-y divide-gray-200">
                        { transactionsByAccount && transactionsByAccount.map((d, key) => 
                            ...
                            <td key={"amount-" + key} className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                {isLoanTab? d.loan.interest == 0? '' : d.loan.interest: d.transactions[activeTab].amount}
                            ...
                            {!isViewing && isLoanTab &&
                                <td key={"loan-"+key} className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                <button type="button" 
